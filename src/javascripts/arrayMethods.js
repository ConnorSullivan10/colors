...
const filterFunct = () => {
  // print out an array of colors that have a hexValue that starts with an 'F'
  const newColors = [];
  // some stuff here
  ...
  // x can be replaced by any variable you want, but x is typically the best shorthand and what you'll see referenced in most documentation
  console.log('filter', filterColors);
};

const findFunc = () => {
  // find the color that has a name of 'green' and console out its hex value
  let colorToFind = {};
...
const mapFunc = () => {
  // create an array of h1 tags for each color name
  const h1Tags = [];
